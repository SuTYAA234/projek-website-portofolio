<nav x-data="{ open: false }" class="bg-blue-500 border-blue-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-500 bg-red-500 hover:text-green-700 focus:outline-none transition ease-in-out duration-150">
